...
static inline const char *LGLensRectNotifyName(uint32_t slotIndex) {
    switch (slotIndex) {
        case LGLensRectSlotPrefsSegment:
            return "echoreborn.liquidglass.lensrect.prefssegment";
        case LGLensRectSlotTabBarSelection:
            return "echoreborn.liquidglass.lensrect.tabbarselect";
        case LGLensRectSlotNowPlayingArtwork:
            return "echoreborn.liquidglass.lensrect.npartwork";
        default:
            return NULL;
    }
}
