...
// Plain C functions defined in GlassKit/LGGlassKit.x and GlassKit/LGLiveBackdropView.m.
// Tweak.xm is compiled as Objective-C++, so without C linkage these references get
// C++ name mangling and fail to link against the C definitions.
#ifdef __cplusplus
extern "C" {
#endif
