...
#import "../GlassKit/LGHostRegistry.h"
#import "../GlassKit/LGLensRectState.h"
#import "LGSymbolResolver.h"
#import "../GlassKit/LGCoverSheetState.h"
#include <stdio.h>
#include <stdarg.h>
#include <string.h>
#include <time.h>
...
#define LG_LOG_PATH "/var/mobile/Library/Accessibility/echoreborn-liquidglass.log"
#define LG_SAFE_MODE_LOG_PATH "/var/mobile/Library/Accessibility/echoreborn-liquidass-safemode.log"
#define LG_SAFE_MODE_STATE_PATH "/var/mobile/Library/Accessibility/echoreborn-liquidass-backboardd-guard.bin"
#define LG_SAFE_MODE_PENDING_PATH "/var/mobile/Library/Accessibility/echoreborn-liquidass-backboardd-alert"
#define LG_GAUSSIAN_IDENTITY_STATE_PATH "/var/mobile/Library/Accessibility/echoreborn-liquidass-gaussian-identity-state.bin"

static CFStringRef const kLGSafeModeNotification =
    CFSTR("com.strive.echoreborn/BackboarddSafeMode");
...
static const char *kCustomFilterTypeName = "echoreborn.liquidglass.refraction";
...
static const char *kClockSharedMaskPath =
    "/var/mobile/Library/Accessibility/echoreborn-liquidglass-clock-mask-shared.bin";
...
static NSString *lgPrefsPath(void) {
    ...
    dispatch_once(&once, ^{
        cached = jbroot(@"/var/mobile/Library/Preferences/com.strive.echoreborn.preferences.plist");
    });
    return cached;
}
static NSString * const kLGPrefsReloadNote = @"com.strive.echoreborn/ReloadPrefs";
static CFStringRef const kLGParametersReloadedNote =
    CFSTR("echoreborn.liquidglass/ParametersReloaded");
